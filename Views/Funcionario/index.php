...
<section class="flex flex-col md:flex-row h-screen items-center">
    ...
    <div class="bg-indigo-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
        <img src="https://i0.wp.com/grupobisutti.com.br/wp-content/uploads/2022/05/CI_DE_22.03.25-16-1-scaled.jpg?fit=2048%2C1365&ssl=1" alt="" class="w-full h-full object-cover">
    </div>
